...
\begin{abstract}
   ...
   urnikov, predstavljena je tudi metoda merjenja kakovosti izdelanega urnika. Med postopki za izdelavo urnikov njademo pozdresno metodo in optimizacijske metode.
\end{abstract}
...
\[
   k_1 \cdot u_1 + k_2 \cdot u_2 + \dotsc + k_{n-1} \cdot k_{n-1} + k_n \cdot u_n
\]
