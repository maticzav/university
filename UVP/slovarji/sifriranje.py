...
def sifriraj(sifra, beseda):
    sifrirana_beseda = ""
    for crka in beseda:
        sifrirana_beseda += sifra.get(crka)
    return sifrirana_beseda
...
def inverz(sifra):
    if not ali_je_sifra(sifra):
        return None
    return {sifrirana_crka: crka for crka, sifrirana_crka in sifra.items()}
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxMzg4fQ:1jG4Fr:3UFsEO7B3aHfmxrgv1e9CgKt1FM'
        try:
            nasa_sifra = {'Č': 'K', 'A': 'O', 'C': 'Z', 'B': 'M', 'E': 'V',
                          'D': 'C', 'G': 'P', 'F': 'E', 'I': 'B', 'H': 'F',
                          'K': 'I', 'J': 'A', 'M': 'U', 'L': 'H', 'O': 'R',
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxMzg5fQ:1jG4Fr:VFvwR8hNLOA9tEz_XOKEsBalH80'
        try:
            nasa_sifra = {'Č': 'K', 'A': 'O', 'C': 'Z', 'B': 'M', 'E': 'V',
                          'D': 'C', 'G': 'P', 'F': 'E', 'I': 'B', 'H': 'F',
                          'K': 'I', 'J': 'A', 'M': 'U', 'L': 'H', 'O': 'R',
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxMzkwfQ:1jG4Fr:HuVb87HMm0Lj_mh_Mv6KLU1yBvo'
        try:
            nasa_sifra = {'Č': 'K', 'A': 'O', 'C': 'Z', 'B': 'M', 'E': 'V',
                          'D': 'C', 'G': 'P', 'F': 'E', 'I': 'B', 'H': 'F',
                          'K': 'I', 'J': 'A', 'M': 'U', 'L': 'H', 'O': 'R',
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxMzkxfQ:1jG4Fr:QZOI17ecHNCDjhyh0__DihIllIU'
        try:
            nasa_sifra = {'Č': 'K', 'A': 'O', 'C': 'Z', 'B': 'M', 'E': 'V',
                          'D': 'C', 'G': 'P', 'F': 'E', 'I': 'B', 'H': 'F',
                          'K': 'I', 'J': 'A', 'M': 'U', 'L': 'H', 'O': 'R',
