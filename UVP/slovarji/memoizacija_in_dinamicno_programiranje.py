...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxMzQ5NX0:1jG4o8:CVAOVi07U_HzohjPvsYffseIrIA'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxMzQ5N30:1jG4o8:gGKs77wxmkmpQ6AlOjgXJXMdnDI'
        try:
            A = [[5, 7, 3, 6], [2, 7, 3, 4], [1, 3, 9, 2], [6, 6, 4, 2]]
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxMzQ5OH0:1jG4o8:FR9t8r-7dFnEH_JjTB-z39nBvIk'
        try:
            sesteti_pari = []
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxMzQ5OX0:1jG4o8:G6r2CGUHA0dzcw7BV-vOcYpJqYY'
        try:
            A = [[5, 7, 3, 6], [2, 7, 3, 4], [1, 3, 9, 2], [6, 6, 4, 2]]
