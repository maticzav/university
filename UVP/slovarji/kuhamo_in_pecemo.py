...
#     {'jajca': 8, 'moka': 1000}
# =============================================================================
def pomnozi(sestavine, n):
    for sestavina in sestavine:
        sestavine[sestavina] *= n
    return sestavine
...
def kaj_moramo_se_kupiti(recept, shramba):
    trgovina = {}
    for sestavina, kolicina in recept.items():
        kolicina_v_shrambi = shramba.get(sestavina, 0)
        if kolicina_v_shrambi < kolicina:
            trgovina[sestavina] = kolicina - kolicina_v_shrambi
    return trgovina
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxMzkyfQ:1jG44x:uGNcH1oeep38xSInYOJOqWx4Bp0'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxMzkzfQ:1jG44x:zMfEjmDvMmnmyt2Pz_6gaU9jmpM'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxMzk0fQ:1jG44x:X3oMapXME1ggUCPlm3VmRxl7KZA'
        try:
