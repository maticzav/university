...
def zdruzi_sladkosnede(domaci, njihovi):
    for clan in njihovi:
        if clan not in domaci:
            domaci[clan] = njihovi[clan]
    return domaci
...
#     {'pita': 1}
# =============================================================================
def nakupovalni_seznam(zelje, potrjeni):
    seznam = {}
    for clan, sladica in zelje.items():
        if clan in potrjeni:
            seznam[sladica] = seznam.get(sladica, 0) + 1
    return seznam
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoyMDMzN30:1jG3t5:jTZWFfthYB4WZKBdCwcOGSvz4Yw'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoyMDMzOH0:1jG3t5:aK_HxYyFpZBtdajQPgkusvPAsEc'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoyMDMzOX0:1jG3t5:uvFCUAsdmSkLRJBFPy3g89K7-7c'
        try:
