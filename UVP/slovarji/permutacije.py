...
#     3
# =============================================================================
def slika(permutacija, n):
    return permutacija.get(n)
...
def je_permutacija(permutacija):
    a = set(permutacija.keys())
    b = set(permutacija.values())
    dolzina = max(a)
    test = set(range(1, dolzina + 1))
    return a == test and b == test
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxMzc5fQ:1jG4U0:EidXg-daIu_3ebIYGbpej90UT4I'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxMzgwfQ:1jG4U0:tCnlYEfwA9tRA-CR_6CoRkdSqPI'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxMzgxfQ:1jG4U0:uzAeW30r5RHVrXx4lwk755D1-z4'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxMzgyfQ:1jG4U0:kQ6_PZCTO8QWu6w83izX7TJg5Iw'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxMzgzfQ:1jG4U0:7KWnrG2rN8r6IXN18dpM1nwUsSA'
        try:
