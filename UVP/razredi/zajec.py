...
# =============================================================================
    def __lt__(self, other):
        if self.teza == other.teza:
            return self.starost < other.starost
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxNzA2fQ:1jQQgZ:hPZQqbt-yckzoItVtZch9hMllsg'
        try:
            test_data = [
                ('Zajec(5, 3).teza', 5),
                ('Zajec(5, 3).starost', 3),
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxNzA3fQ:1jQQgZ:SVgfvaWvMAhTyPU9k2AgjG2C8jk'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxNzA4fQ:1jQQgZ:sUKY2HyDICGU5Cl2WmWfn03YJVw'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxNzA5fQ:1jQQgZ:8rDXw8C8ph0bLFEBIA63ZxabGgA'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxNzEwfQ:1jQQgZ:EYczNz-TRmMKCQfx2yfq0vIpAwA'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxNzExfQ:1jQQgZ:doSFigoH9KYi7KALjtyMeGZfJCE'
        try:
