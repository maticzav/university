...
# in `False`, če ni).
# =============================================================================
def prenesi(prejemnik, naslovnik, koliko):
    if prejemnik.dvig(koliko):
        naslovnik.polog(koliko)
        return True
    else:
        return False
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxNzEyfQ:1jQQgV:Mj5ep5-elw4xgnFmToN_lH4R6g4'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxNzEzfQ:1jQQgV:_vk2sOESLOV_mlTJy68-r20K2MI'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxNzE0fQ:1jQQgV:256ji2tq9JCWJr7-pGDbNgx78IY'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxNzE1fQ:1jQQgV:sifisJQxBb_eKTd0-x7kx-8tkQs'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxNzE2fQ:1jQQgV:wWFJ6ZrcB74S6km8bg9BoeMKHto'
        try:
            test_data = [
