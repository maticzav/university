...
# =============================================================================
def poudari(naslov: str):
    return " ".join([znak.upper() for znak in naslov])
...
def poudari_besede(naslov):
    ...
    for znak in naslov:
        if znak == "*":
            poudarjen = not poudarjen
        elif poudarjen:
            poudarjen_naslov += znak.upper()
        else:
            poudarjen_naslov += znak
    return poudarjen_naslov
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxNDYzfQ:1jMq5h:YK2b7Lqd5O-OZt3riqDD_7GCpyA'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxNDY0fQ:1jMq5h:i7Tz9REa41Izt0cZk8KQaOTbJ-8'
        try:
