...
# =============================================================================
def preberi_podatke(vhodna):
    with open(vhodna) as d:
        csv = [tuple(tek.split(",")) for tek in d.readlines()]
    slovar = {}
    for datum, dolzina, cas in csv:
...
#     \end{document}
# =============================================================================
def pretvori_v_latex(vhodna, izhodna):
    podatki = preberi_podatke(vhodna)
    latex = r"""
    \documentclass[a4paper, 12pt]{amsart}
\usepackage[utf8]{inputenc}
\usepackage[slovene]{babel}
...
\end{document}
    ...
    for datum in podatki:
        dolzina, cas = podatki[datum]
        tabela += "{0} & {1} & {2} & {3} \\\n".format(datum, dolzina, cas, povprecna_hitrost(dolzina, cas))
    latex = latex.format(tabels)
    # izpisi podatke
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0Ijo5OTc0fQ:1jMrWs:WLdGZrp0hjBBEyDH_Vdzaaape2g'
        try:
            pass
        except:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0Ijo5OTc1fQ:1jMrWs:IBwxS1yG6HF4PchorOlGLCq6n78'
        try:
            pass
        except:
            Check.error("Testi sprožijo izjemo\n  {0}",
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0Ijo5OTc2fQ:1jMrWs:15y1l4qrXJaXvvgGqcjI_YFRP78'
        try:
            pass
        except:
            Check.error("Testi sprožijo izjemo\n  {0}",
