...
#      SICER BO RED NAREDILA POLICIJA!'
# =============================================================================
def zagrozi(sporocilo):
    return sporocilo.upper().replace(".", "!")

def prepisi_in_zagrozi(vhodna, izhodna):
    with open(vhodna) as vhodna_datoteka:
        with open(izhodna, "w") as izhodna_datoteka:
            izhodna_datoteka.write(zagrozi(vhodna_datoteka.read()))
...
def groznje_z_dovolj_klicaji(datoteke):
    datoteke_z_dovolj_klicaji = []
    for datoteka in datoteke:
        with open(datoteka) as d:
            if d.read().count("!") >= 3:
                datoteke_z_dovolj_klicaji.append(datoteka)
    return datoteke_z_dovolj_klicaji
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoyMDM0Nn0:1jLLA4:uQ6EYcTpHW3-fOWuDdJ0R-fzVAk'
        try:
            test_cases = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoyMDM0N30:1jLLA4:--6EpI_QEZiRIoxDpgwBEwXzOXA'
        try:
            test_cases = [
