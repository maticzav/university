...
#     'J?'
# =============================================================================
def nepravilni_ugibi(geslo: str, ugibi: str):
    geslo = geslo.lower()
    nepravilni = [x for x in ugibi if x.lower() not in geslo]
    return "".join(nepravilni)
...
#     >>>
# =============================================================================
def stevilo_napak(geslo, ugibi):
    return len(nepravilni_ugibi(geslo, ugibi))
...
#     >>>
# =============================================================================
def poraz(geslo, ugibi, max_napak=10):
    return stevilo_napak(geslo, ugibi) > max_napak
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoyNDE3N30:1jDC1f:oQx8xNAAvt7DzXhiUjl0J128l90'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoyNDE3OH0:1jDC1f:_qtmmUiDkYr2i_WMihctUm80rqw'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoyNDE3OX0:1jDC1f:F7AR8ED6PVBRzWsMOEdMQZvP2lg'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoyNDE4MH0:1jDC1f:JHcdQpHjJEXARp2BfFUTGeoRd4Y'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoyNDE4MX0:1jDC1f:Rnly_EqO4t5aC0vzJpRJeLHpfPo'
        try:
