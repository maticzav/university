...
#     False
# =============================================================================
def naivna_resitev(sez: str):
    return sez.count('(') == sez.count(')') and sez.count('[') == sez.count(']') and sez.count('{') == sez.count('}')
...
def gnezdeni_oklepaji(niz: str):
    ...
    for znak in niz:
        if znak in oklepaji:
            ...
            if sklad == []:
                return False
            if sklad[-1] != oklepaji[zaklepaji.index(znak)]:
                return False
            else:
                sklad.pop()
    return len(sklad) == 0
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoyMDI2OX0:1jDBLA:YdWQPlgl9LRs18AzGMOntHEKvzs'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxMzM5NH0:1jDBLA:-VeRUZEtR86NhcTpk04TjCWWT7s'
        try:
