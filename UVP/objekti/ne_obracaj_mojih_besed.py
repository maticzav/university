...
# =============================================================================
def obrni_vrstni_red(niz: str):
    obrnjene_besde = niz.split()[::-1]
    return " ".join(obrnjene_besde)
...
# =============================================================================
def obrni_besede(niz: str):
    obrnjene_besede = [beseda[::-1] for beseda in niz.split()]
    return " ".join(obrnjene_besede)
...
# =============================================================================
def sosed_naj_trpi(niz: str):
    presledki = [i for i, crka in enumerate(niz) if crka == " "]
    trpljenje = [crka for crka in niz if crka != " "][::-1]
    for i in presledki:
        trpljenje = trpljenje[:i] + [" "] + trpljenje[i:]
    return "".join(trpljenje)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoyMDI3N30:1jDDkZ:okCc7tOyDNkswPVLomFTECB0NjM'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoyMDI3OH0:1jDDkZ:Tppx78BR-gqAp181sixwKcEEpp0'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoyMDI3OX0:1jDDkZ:vm5DMk4JGDEf7xR054HezL1l7y8'
        try:
