...
#     [1, 0, 1, 0, 3]
# =============================================================================
def prestej_crke(geslo: str, niz: str):
    niz = niz.lower()
    geslo = geslo.lower()
    return [niz.count(crka) for crka in geslo]
...
def sestej_stevke(stevke):
    ...
    for n in range(len(stevke) - 1):
        vsota = stevke[n] + stevke[n + 1]
        if vsota >= 10:
            sestevek += razbij_na_stevke(vsota)
        else:
            sestevek.append(vsota)
    return sestevek
...
#     87
# =============================================================================
def ujemanje(oseba1: str, oseba2: str, geslo='LOVES'):
    # Števke
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxMzQxM30:1jDDwH:1NLp-JCg_Xa1C_Esg4CF9m8XKFg'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxMzQxNH0:1jDDwH:x9XEuH_0pJSZ1exTX46ezMxQ6cM'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxMzQxNX0:1jDDwH:BslTQ1iVe4jKoXPJHRL8AI6ANX8'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxMzQxNn0:1jDDwH:S0HjYWHZ0iUFq3qRz6TwbzIEnok'
        try:
