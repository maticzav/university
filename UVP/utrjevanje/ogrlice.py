...
def stevilo_ogrlic(b, r):
    # vse kroglice enake barve
    if b == 0 or r == 0:
        return 1

    # razdeli
    prva_bela = stevilo_ogrlic(b - 1, r)
    prva_rdeca = stevilo_ogrlic(b, r - 1)

    return prva_bela + prva_rdeca
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxMDM0fQ:1jJMGJ:MLk_eD-o5ffOXxez3m_TrzJdxq8'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxMDM1fQ:1jJMGJ:gY_zo_N1bXJixU7kxgr_Motcg5o'
        try:
