...
def polarna_razdalja(r1, fi1, r2, fi2):
    ...
    return ravninska_razdalja(r1 * math.cos(fi1), r1 * math.sin(fi1), r2 * math.cos(fi2), r2 * math.sin(fi2))
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxMDM2fQ:1jJMGD:ze3g4env0Pz8lKOfjo16KpNEXPA'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxMDM3fQ:1jJMGD:mAtIEHA7YDeqyBMnSqMIRaN91l4'
        try:
