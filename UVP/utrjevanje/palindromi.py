...
def skoraj_palindrom(niz):
    # treba je eno crko dat stran ali dodati
    if prakticno_palindrom(niz):
        return True
    # treba je eno crko zamenjat
    for n in range(len(niz)):
        if palindrom(niz[:n] + niz[-n - 1] + niz[n + 1:]):
            return True
    return False
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxMDI4fQ:1jJMGF:7AMgGUu0HQOLsR7XMUU2so4Jsh4'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxMDI5fQ:1jJMGF:gq4qlmoiVJ4HKLJaVf7DsSyfAnU'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzU2LCJwYXJ0IjoxMDMwfQ:1jJMGF:GrS72V2XDb3n5u-pOiZVibCwFak'
        try:
